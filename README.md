...
MBTIは個人の指向によってタイプを分類する類型論です。そのため、何かをデータベースに投稿・SNSに共有するとしたら、多種多様な表現方法を持つ作品が個人の指向を最も反映できると考えました。つまり、作品を通してタイプごとの好みの傾向が表れるのではないかと思ったからです。

MBTIは個人の指向に基づいてタイプを分類する指標であるため、データベースへの投稿や共有において、多様な表現方法を持つ作品が個人の指向をより明確に反映すると考えられます。よって、タイプごとに作品に対する好みや傾向の違いが顕著に表れるのではないかと推測し、"作品" に焦点を当てました。
