...
- ユーザーの診断方法  
そのユーザーのタイプ診断が  
    - 診断サイト（[16personalities](https://www.16personalities.com/ja)）での診断を参考にしたり、書籍やWedサイトなどでMBTIに関する情報を集めて、自らの判断で決定したものなのか？（自認タイプ）  
    - 公式のセッションを通じて決定したものなのか？（[公式](https://www.mbti.or.jp/)自認タイプ）  

- ex.
フィルタリング機能で  
    - 公式タイプに絞り、公式を通して診断されたものだからこのデータは信用できる  
    - 自認タイプ・公式タイプの全てを選択し、このデータは誤診を考慮して見なければいけないな  
など。
