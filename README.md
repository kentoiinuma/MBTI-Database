...
## サービス概要  
MBTIタイプ診断をしたことのあるユーザーが、メディア(アニメ・音楽・ゲーム)ごとに、好きな作品を投稿することにより、MBTIタイプごとの好みをデータベース化するWedアプリケーションです。  
...
## ユーザー層について   
- MBTI診断サイトでタイプ診断をしたことがあり、アニメ・音楽・ゲーム　などの作品が好きなユーザー
...
- ユーザーはコンテンツ投稿画面から、アニメ・音楽・ゲームのそれぞれ3つのメディアから自分が好きな1〜4つの作品を選び、その作品のサムネイルを組み合わせ生成した画像コンテンツをアプリ内に投稿・Xに共有できる。  
    - メディアをアニメ・音楽・ゲームにした理由はメジャーであり私も好きだから。
    - ex. メディアでアニメを選択し、作品で呪術廻戦,葬送のフリーレン,進撃の巨人を選択すれば、上記３つの作品のサムネイルを組み合わせ生成した画像コンテンツをアプリ内に投稿・Xに共有できる。
